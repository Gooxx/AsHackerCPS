//
//  ASHMyCollectTableViewController.m
//  AsHackerCPS
//
...
#import "ASHMyCollectTableViewController.h"

@interface ASHMyCollectTableViewController ()

@end

static NSString * const kTABLE_CELL = @"cpsMainCell1P";
@implementation ASHMyCollectTableViewController
