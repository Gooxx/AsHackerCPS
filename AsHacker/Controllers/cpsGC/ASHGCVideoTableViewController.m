//
//  ASHGCVideoTableViewController.m
//  AsHackerCPS
//
...
#import "ASHGCVideoTableViewController.h"

@interface ASHGCVideoTableViewController ()

@property(nonatomic,strong)NSArray *dataArr;
@end

@implementation ASHGCVideoTableViewController
